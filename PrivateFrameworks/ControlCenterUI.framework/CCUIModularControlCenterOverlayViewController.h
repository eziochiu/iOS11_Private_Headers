...
@property (nonatomic, readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } overlayAdditionalEdgeInsets;
...
@property (nonatomic, readonly) struct CGSize { double x1; double x2; } overlayContentSize;
